 ...
 * Instagram, YouTube) YO'Q — ular kutubxonadan olib tashlangan.
 * Shuning uchun to'rttasi shu yerda, sodda geometrik shakl sifatida
 * chizilgan.
 *
 * Ular `currentColor` bilan bo'yaladi, ya'ni futerda ham, bosh
 * ekranda ham atrofdagi matn rangiga ergashadi va hover holati
...
export function TelegramIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
      <path d="M21.7 3.5 2.9 10.8c-1.1.4-1.1 1 0 1.3l4.7 1.5 1.8 5.6c.2.6.4.8.9.8.4 0 .6-.2.9-.5l2.3-2.2 4.7 3.5c.9.5 1.5.2 1.7-.8l3.1-14.5c.3-1.2-.5-1.8-1.3-1.5ZM8.9 13.2l9.4-5.9c.4-.3.8-.1.5.2l-8 7.3-.3 3.3-1.6-4.9Z" />
    </svg>
  );
}
